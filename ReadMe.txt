...
Labview executable and source files, as needed to calculate speed of sound in humid air, and its uncertainty,
...
and in additiona a total of 41 subvis, which are required by the main source files, for the calculation of the thermodynamic properties 
of air and water vapor, and their uncertainties.
...
Upon download, it is suggested to copy all the 44 files in the same directory.  

For any additional enquiry regarding the model, and its software implementation in Labview, 
mail to r.gavioso@inrim.it
